...
from app.schemas import Quarto, QuartoCreate, QuartoUpdate, QuartoImagem as QuartoImagemModel
...
def deletar_quarto(
    ...
    for imagem in imagens:
        try:
            ...
            print(f"Erro ao remover arquivo da imagem: {e}")
        db.delete(imagem)

    db.delete(quarto)
    db.commit()
    return {"message": "Quarto e imagens associadas removidos com sucesso"}
